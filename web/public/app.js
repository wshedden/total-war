...
var [countries, topo, neighboursPayload] = await Promise.all([
  fetch("/api/countries").then((r) => r.json()),
  fetch("/api/borders").then((r) => r.json()),
  fetch("/api/neighbours").then((r) => r.json())
]);
var fullCountries = await fetch("/api/countries/full").then((r) => r.json());
